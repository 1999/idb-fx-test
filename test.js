...
describe('Some king of test', function () {
    var openConnRequest = window.indexedDB.open('test_' + Date.now(), 1);

    it('should insert records or return false', function (done) {
        ...
        openConnRequest.addEventListener('success', function (evt) {
            console.log('connection success', this.result);
            var db = this.result;
            
            insertTenUsers(db, function (ok) {
